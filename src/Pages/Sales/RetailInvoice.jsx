...
const RetailInvoicePage = () => {
  {
    /*Tarihlendirme Stateleri*/
  }
  const [deliveryNumber, setDevlieryNumber] = useState("");
  ...
  const deliveryNumberChangeHandler = (e) => {
    e.preventDefault();
    setDevlieryNumber(e.target.value);
  };
      ...
      >
        ...
        >
          <ContentHeaderComponent
            dontUse={true}
            description={"Perakende Satış Faturası (KDV Dahil)"}
          />
        </Box>
            ...
            >
              ...
              <CardContent sx={{ mt: 2 }}>
                ...
                <TextInputComponent
                  ...
                  fullWidth={true}
                  onChangeHandler={deliveryNumberChangeHandler}
                  noValidate={true}
                />
              </CardContent>
            </GridItemComponent>
...
export default RetailInvoicePage;
