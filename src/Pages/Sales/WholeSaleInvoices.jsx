...
const WholeSaleInvoicesPage = () => {
  ...
  //Date counting
  const expirtDateTemp = dayjs(new Date());
  ...
  const shipmentNumberChangeHandler = (e) => {
    e.preventDefault();
      ...
      >
        ...
        >
          <ContentHeaderComponent
            dontUse={true}
            description={"Toptan Satış Faturası (KDV Hariç)"}
          />
        </Box>
            ...
            >
              ...
              <CardContent sx={{}}>
                ...
                <TextInputComponent
                  ...
                  fullWidth={true}
                  onChangeHandler={shipmentNumberChangeHandler}
                  noValidate={true}
                />
              </CardContent>
            </GridItemComponent>
