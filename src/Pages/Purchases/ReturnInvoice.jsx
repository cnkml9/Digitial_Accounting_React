...
const ReturnInvoice = () => {
  ...
  const [purchaseInvoiceDate, setPurchaseInvoiceDate] = useState(dayjs(new Date()));
  ...
  const purchaseInvoiceNumberChangeHandler = (e) => {
    e.preventDefault();
      ...
      >
        <Box sx={{
          ...
          <ContentHeaderComponent
            dontUse={true}
            description={"Yeni Alıştan İade Faturası"}
          />
        </Box>
              ...
              <CardContent sx={{mt: 1}}>
                ...
                >
                  <DatePicker
                    ...
                    onChange={(newReceiptDate) => {
                      setPurchaseInvoiceDate(newReceiptDate);
                    }}
                    label="Alış Fatura Tarihi"
                    format="DD-MM-YYYY"
                  />
                </Stack>
                <TextInputComponent
                  ...
                  label={"Alış Fatura Numarası"}
                  fullWidth={true}
                  onChangeHandler={purchaseInvoiceNumberChangeHandler}
                  noValidate={true}
                />
              </CardContent>
